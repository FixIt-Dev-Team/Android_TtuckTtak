...
class JoinPart3Activity :
    ...
    override fun initAfterBinding() = with(binding) {
            ...
            override fun onFocusChange(view: View, hasFocus: Boolean) {
                if (hasFocus) {
                    ...
                    if (RegexUtil.isValidNickname(nickname)) {
                        edittextName.setBackgroundResource(R.drawable.box_white)
                    } else {
            ...
            override fun onFocusChange(view: View, hasFocus: Boolean) {
                if (hasFocus) {
                    ...
                    if (RegexUtil.isValidPw(password)) {
                        edittextPassword.setBackgroundResource(R.drawable.box_white)
                        textviewPasswordError.visibility = View.INVISIBLE
                        textviewPasswordUsable.visibility = View.VISIBLE
                    } else {
                        edittextPassword.setBackgroundResource(R.drawable.box_error_text)
        ...
        edittextPasswordCheck.setOnFocusChangeListener(object : View.OnFocusChangeListener {
            override fun onFocusChange(view: View, hasFocus: Boolean) {
                if (hasFocus) {
                    edittextPasswordCheck.setBackgroundResource(R.drawable.box_input_text)
                    ...
                    if (pw.equals(pwCheck)) {
                        edittextPasswordCheck.setBackgroundResource(R.drawable.box_white)
                        textviewPasswordDiscordance.visibility = View.INVISIBLE
                    } else {
                        edittextPasswordCheck.setBackgroundResource(R.drawable.box_error_text)
